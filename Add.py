...
def add_songs():
    ...
    title_box = Entry(root, font=("ariel", 14), bg="white", fg="black")
    title_box.place(x=420, y=200, height=30, width=500)

    artist_box =Entry(root, font=("ariel", 14), bg="white", fg="black")

    artist_box.place(x=420, y=250, height=30, width=500)

    genre_box=Entry(root, font=("ariel", 14), bg="white", fg="black")
    genre_box.place(x=420,y=300,height=30,width=500)

    release_year_box=Entry(root, font=("ariel", 14), bg="white", fg="black")
    release_year_box.place(x=420,y=350,height=30,width=500)

    language_box=Entry(root, font=("ariel", 14), bg="white", fg="black")
    language_box.place(x=420,y=400,height=30,width=500)

    album_box = Entry(root, font=("ariel", 14), bg="white", fg="black")
